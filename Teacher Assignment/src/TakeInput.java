...
public class TakeInput {
    ...
    public TakeInput(){
        ...
        try {
            ...
            try{
                System.out.println("operation Successfull try");

                Parent root= FXMLLoader.load(getClass().getClassLoader().getResource("operationSuccessful.fxml"));
                Stage newStage=new Stage();
                Scene newScene=new Scene(root,300,100);
