 ...
 */
public class Z_RoutineGridShowAdminController implements Runnable{
    @FXML
    private Stage chooseCourseStage;
    private Scene chooseCourseAdminScene;
    private Parent chooseCourseAdminRoot;
    ...
    public void initialize(){
        ...
        RoutineGridShowAdminController temObjForThisClass=new RoutineGridShowAdminController();
        //Thread t=new Thread(temObjForThisClass);
        //t.start();
    }
    ...
    public void actionForComboBox() {
        ...
        updateTheoryLabCounterLabelFromComboBoxFunction();
    ...
    public void addOptionToFacultyComboBox(){
        ...
        facultyShowComboBox.getItems().removeAll(facultyShowComboBox.getItems());
    ...
    public void updateTheoryLabCounterLabel(){
        ...
        if(tempForCountingClass!=null) {
            String tempCounter = Integer.toString(tempForCountingClass.theory);
            facultyTheoryCounter.setText(tempCounter);
            tempCounter = Integer.toString(tempForCountingClass.lab);
            facultyLabCounter.setText(tempCounter);
        }
        //mouseMoveAction();
        //actionForComboBox();
    ...
    public void updateTheoryLabCounterLabelFromComboBoxFunction(){
        facultyTheoryCounter.setText("-");
        facultyLabCounter.setText("-");
