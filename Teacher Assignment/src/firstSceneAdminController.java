 ...
 */
public class firstSceneAdminController {
    @FXML
    ...
    public void actionForAutoGenerateMenuItem(){
        ...
        try{
            ...
            Scene newScene=new Scene(root,500,250);

            newStage = new Stage();

            newStage.setTitle("Generating...");
            newStage.setScene(newScene);
            newStage.setResizable(false);
            newStage.centerOnScreen();
        ...
        try{
            Parent chooseCourseAdminRoot= FXMLLoader.load(getClass().getClassLoader().getResource("fullRoutineObserve.fxml"));
            Scene chooseCourseAdminScene=new Scene(chooseCourseAdminRoot,850,500);

            Stage chooseCourseStage = (Stage) copyRightLabel.getScene().getWindow();
